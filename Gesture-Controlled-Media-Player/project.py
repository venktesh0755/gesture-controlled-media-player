...
def create_trackbars():
    ...
    cv2.createTrackbar('SatMin', 'Trackbars', 167, 255, empty)
    cv2.createTrackbar('SatMax', 'Trackbars', 255, 255, empty)
    cv2.createTrackbar('ValMin', 'Trackbars', 171, 255, empty)
...
while(1):
    ...
    if(centroid_x,centroid_y) != (-1,-1):
        ...
        hand_detected = cv2.contourArea(max_cntr) >= 10000 # Max contour area must be greater than thois threshold 
